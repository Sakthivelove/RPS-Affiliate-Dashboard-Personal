                ...
                <DialogBody className="w-full h-full" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                   <div className="flex flex-col h-full justify-center items-center">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-[#969EB2] rajdhani-bold text-[1rem] md:text-[2rem] mt-[0.5rem] md:mt-[1rem]">Rock tournament has created successfully</p>
                        </div>
                   </div>
                </DialogBody>
            </div>
...
const CreateNewRockTournament : React.FC = () => {
    ...
    const [_players, setPlayers] = useState<number | null>(null);
